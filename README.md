...
<pre><code>
(ES_PASSWORD=<b><i>ELASTIC_PASSWORD</i></b>) python3 manage.py (--config=<b><i>local/staging/prod</i></b>) update-conf --rebuild --indexes=<b><i>dots_document_byresource/dots_collection_byresource</i></b>
</code></pre>
...
<pre><code>
curl -X POST "http://localhost:9200/dots_document_byresource/_refresh?pretty"
curl http://localhost:9200/_cat/indices?v
</code></pre>

- with ES security enabled:
<pre><code>
curl -X POST "http://elastic:<b><i>ELASTIC_PASSWORD</i></b>@localhost:9200/dots_document_byresource/_refresh?pretty"
...
> For servers, apps may be started via processes management tools, refer to the servers documentation
  ...
  - Then visit http://localhost:5003/api/1.0/search?query=*&index=dots_document_byresource to test it is running
