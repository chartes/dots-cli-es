...
# def register_search_endpoint(app, api_version="1.0", compose_result_func: Callable[[str], list] = lambda s: []):
#     """
#     This function will register the /search route directly with the app.
#     It will process the search request, apply filters, pagination, and return results.
#
#     :param app: Flask app instance
#     :param api_version: API version to be used in the URL
#     :param compose_result_func: Function to transform search results from ES into the desired output format
#     """
#
...
#             # Elasticsearch query body setup
#             body_query = {
#                 "query": {
#                     "bool": {
#                         "must": []
...
#                 print('must_clauses : ', must_clauses)
#                 if must_clauses:
...
#                                 "query": {
#                                     "query_string": {
#                                         "query": f"({query_param}) AND {groupby_field}:{bucket['key'][groupby_field]}"
#                                     }
#                                 },
#                                 "size": size_limit
#                             }
            ...
            # === CAS 2 : Recherche groupée par resource (hits + highlights dans la même requête) ===
                ...
                for b in buckets:
                    ...
                    grouped_results.append({
                        ...
                        "collection_id": first_hit_source.get("collection_metadata", {}).get("collection_id", {}),
                        "hits": [
                            {
